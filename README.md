...
Using three datasets—`customers.csv`, `products.csv`, and `transactions.csv`—we:
- Clustered customers (K-Means, k=4) by spend, quantity, preferences, and demographics.
- Identified top-selling products, seasonal trends, and regional performance.
- Applied cosine similarity to build a Lookalike Model for high-precision targeting.
